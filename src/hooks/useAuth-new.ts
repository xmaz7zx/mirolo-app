...
const PRODUCTION_URL = 'https://mirolo-app.vercel.app'
const AUTH_CALLBACK_URL = `${PRODUCTION_URL}/auth-callback.html`
...
export const useAuth = () => {
  ...
  const signInWithEmail = async (email: string) => {
    console.log('Using redirect URL:', AUTH_CALLBACK_URL)
  ...
  const signUp = async (email: string, displayName?: string) => {
    console.log('Using redirect URL for signup:', AUTH_CALLBACK_URL)
